...
const InstructorRatingIND = ()=>{
  ...
  console.log(userId);
    ...
    const rateCourse = async()=>{
        try{
            setLoading(true);
            const res = await axios.patch(`http://localhost:8000/api/IndividualTrainee/insRating?id=${userId}`,{rating: rating})
...
export default InstructorRatingIND;