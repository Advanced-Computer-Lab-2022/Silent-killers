...
//   const [email,setEmail] = useState(null);
  ...
  return (
    <div className="App">
      ...
      {/* <input type="text" value={email} onChange={(e)=>{setEmail(e.target.value)}} /> <br /><br /> */}
        ...
        <p> {results}</p>	
        <p><Link to="/courseRating"> Rate the course </Link></p>
        <p><Link to="/requestaccess2">Request Access to this course </Link></p>
  ...
  export default ViewCoursebyIdCT;