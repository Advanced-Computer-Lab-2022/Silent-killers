...
const ViewTraineeGradeIT = () => { 
  ...
  console.log(userId);
      ...
      const ttt =  async () => {
        ...
        await axios.post(`http://localhost:8000/api/IndividualTrainee/viewgradeIT/?id=${localStorage.getItem("user")}`).then(
          (res) => { 
  ...
  export default ViewTraineeGradeIT;