...
const ReportIT = () => { 
  ...
  console.log(localStorage.getItem("user"));
      ...
      const ttt =  async () => {
        ...
        await axios.post(`http://localhost:8000/api/IndividualTrainee/reportIT/?course=${localStorage.getItem("course")}&coursetitle=${localStorage.getItem("coursetitle")}&id=${localStorage.getItem("user")}`,{problem:problem}).then(
          (res) => {
