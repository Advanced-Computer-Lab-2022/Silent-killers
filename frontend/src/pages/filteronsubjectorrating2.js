...
const UsersList = () => { 
  ...
  const [authors,setAuthors] = useState([]);
    ...
    const getAuthors =  async () => {
      await axios.post(`http://localhost:8000/api/Guest/filterratingorsubject`, {Subject:Subject,Rating:Rating}).then(
        (res) => { 
    ...
    return(
        ...
        <div className="UsersList">
            ...
            <label>Rating : </label>
      <input type="text" value= {Rating} onChange={(e)=>{setRating(e.target.value)}} Price/> <br /><br />
      <label>Subject : </label>
